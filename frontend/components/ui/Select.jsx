      ...
      <button
        ...
        className={`
          ...
          ${disabled
            ...
            : "cursor-pointer border-slate-200 text-slate-800 hover:border-orange-200 hover:bg-orange-50/50 focus:outline-none focus:ring-2 focus:ring-orange-400/60 focus:ring-offset-1"
          }
          ${open ? "border-orange-300 bg-orange-50/50 ring-2 ring-orange-400/20" : ""}
        `}
      >
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isSelected
                      ...
                      : "text-slate-700 hover:bg-slate-50 active:bg-orange-50"
                    }
                  `}
                >
                  {opt.label}
